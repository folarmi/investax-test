      ...
      try {
        ...
        if (storedTasks) {
          ...
          const mockTasks = [
            {
              _id: "1",
              title: "Complete project documentationsss",
              description:
      ...
      <div className="flex items-center flex-wrap justify-between mb-4">
        <div className="flex space-x-2">
          <button
            ...
            className={`px-3 py-1 rounded ${filterStatus === "all" ? "bg-blue-500 text-white" : "bg-gray-200 text-gray-700"}`}
          >
            All
          </button>
          <button
            onClick={() => setFilterStatus("complete")}
            className={`px-3 py-1 rounded ${filterStatus === "complete" ? "bg-green-500 text-white" : "bg-gray-200 text-gray-700"}`}
          >
            Completed
          </button>
          <button
            onClick={() => setFilterStatus("incomplete")}
            className={`px-3 py-1 rounded ${filterStatus === "incomplete" ? "bg-yellow-500 text-white" : "bg-gray-200 text-gray-700"}`}
          >
            Incomplete
          </button>
        </div>
        ...
        <input
          ...
          className="border p-1 rounded w-64 mt-4 text-black"
        />
      </div>
